...
export default function TopNav({
    ...
    return <header>
        <nav className={`${customClass} ${isMenuActive ? 'left-15' : ' max-sm:left-0 left-15'} transition-all px-2  fixed top-0  h-12 bg-neutral flex justify-between left-0 right-0 items-center`}> 
